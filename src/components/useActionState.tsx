...
const createAction = async (currentState: any, formData: FormData) => {
  ...
  return { ...data, success: true } // success flag လေး ထည့်ပေးလိုက်ပါ
}
    ...
    <div className="p-10 space-y-6">
      ...
      {currentItem && !state?.error && (
        <div className="mt-4 p-6 border rounded-lg shadow-md bg-white">
          ...
          <p className="text-md mb-4 text-slate-600">Vote Count: <span className="text-blue-600 text-xl font-bold">{currentItem.vote}</span></p>
